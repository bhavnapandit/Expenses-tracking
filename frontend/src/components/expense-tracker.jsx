...
export function ExpenseTracker() {
  ...
  const fetchExpenses = async () => {
    try {
      const res = await axios.get(
        `https://expenses-tracking-xi.vercel.app/api/expense/${user._id}`
      );
      return res.data;
    } catch (error) {
  ...
  const addExpense = async (expense) => {
    try {
      ...
      const res = await axios.post(
        "https://expenses-tracking-xi.vercel.app/api/expense",
        payload
      );
  ...
  const deleteExpense = async (id) => {
    try {
      await axios.delete(`https://expenses-tracking-xi.vercel.app/api/expense/delete/${id}`);
